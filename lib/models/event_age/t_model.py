...
def model_trim(df, event_column_list, timestamp_column, fake_timestamp=False,
   ...
   mlib.vprint(mlib.m_config["cli"]["trim_verb"], 
               f"Event Age Model: trims by timestamp", 1)
   ...
   mlib.vprint(mlib.m_config["cli"]["trim_verb"], 
               f"Event Age Model: initial information = {total_info}", 1)
   ...
   if mlib.m_config['cli']['save_evolution']:
      mlib.vprint(mlib.m_config["cli"]["trim_verb"], 
               (f"Event Age Model: Saving evolution = "
   ...
   # final touchups
   mlib.vprint(mlib.m_config["cli"]["trim_verb"], 
                 f"Event Age Model: information after trimming = {total_info}", 1)
